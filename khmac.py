...
class KHMAC :
    ...
    def __init__(self, key :bytes, msg :bytes, hash = "sha1"):
        ...
        if key_size > block_size :
            ...
            key = hash(key).ljust(block_size, b'\x00')
        ...
        self.block_1 = hash(XOR(key, opad))

        # step 3 -- calculate hash((k + ipad) || m)
        self.block_2 = hash(XOR(key, ipad))
